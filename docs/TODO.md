...
- [x] make sure the UI works and BE works
- [x] make sure github actions are set up to deploy to surri.xuresolutions.in
- [x] any changes pushed to master, should auto deploy to surri.xuresolutions.in
