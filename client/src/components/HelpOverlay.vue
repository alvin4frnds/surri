...
<template>
  ...
  <button
    @click="show = true"
    class="fixed bottom-4 right-4 z-[40] w-10 h-10 rounded-full bg-slate-700/90 hover:bg-slate-600 text-slate-200 text-lg font-bold flex items-center justify-center shadow-lg border border-slate-500/50 transition-colors"
  >
    ?
  </button>
  ...
  <Teleport to="body">
    <Transition name="help-fade">
      <div v-if="show" class="fixed inset-0 z-[50] bg-black/80 flex items-center justify-center p-4" @click.self="show = false">
        <div class="bg-slate-800 border border-slate-600 rounded-2xl max-w-[360px] w-full max-h-[80vh] overflow-y-auto p-5 space-y-4">
          <div class="flex items-center justify-between">
            <h2 class="text-lg font-bold text-slate-100">How to Play Surri</h2>
            <button @click="show = false" class="text-slate-400 hover:text-white text-xl font-bold">&#x2715;</button>
          </div>

          <div class="space-y-3 text-sm text-slate-300 leading-relaxed">
            <section>
              <h3 class="text-slate-100 font-semibold mb-1">Overview</h3>
            ...
            <section>
              <h3 class="text-slate-100 font-semibold mb-1">Bidding</h3>
            ...
            <section>
              <h3 class="text-slate-100 font-semibold mb-1">Bid 10+</h3>
              <p>Partner's hand is revealed to everyone. The bidder plays cards for both hands.</p>
            </section>

            <section>
              <h3 class="text-slate-100 font-semibold mb-1">Playing Tricks</h3>
              <ul class="list-disc list-inside space-y-1">
            ...
            <section>
              <h3 class="text-slate-100 font-semibold mb-1">Scoring</h3>
            ...
            <section>
              <h3 class="text-slate-100 font-semibold mb-1">Winning</h3>
            ...
            <section>
              <h3 class="text-slate-100 font-semibold mb-1">Special Moves</h3>
              <ul class="list-disc list-inside space-y-1">
